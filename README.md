...
This is a rails API app that manages the backend for a react app that displays a random greeting.

[Click here to see the front end React app](https://github.com/zamcham/hello-rails-front-end)
...
This project requires Ruby on Rails additional dependencies. Also, it uses RuboCop as a linter and you should set it up as well.
